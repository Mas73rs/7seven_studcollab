...
public class TroisiemeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        schoolMatiereModelList.add ( new SchoolMatiereModel ( R.mipmap.three,"composition_francaise_troisieme" ) );
        ...
        schoolMatiereModelList.add ( new SchoolMatiereModel ( R.mipmap.three,"svt_troisieme" ) );
        schoolMatiereModelList.add ( new SchoolMatiereModel ( R.mipmap.three,"Allemand troisieme" ) );
        schoolMatiereModelList.add ( new SchoolMatiereModel ( R.mipmap.three,"Dictee troiseme" ) );
        schoolMatiereModelList.add ( new SchoolMatiereModel ( R.mipmap.three,"Anglais_troisieme" ) );
        schoolMatiereModelList.add ( new SchoolMatiereModel ( R.mipmap.three,"histoire Troisieme" ) );
        schoolMatiereModelList.add ( new SchoolMatiereModel ( R.mipmap.three,"Pct Troisieme" ) );



        //////:fin de la listeAnglais_troisieme
        //////:fin de la liste
